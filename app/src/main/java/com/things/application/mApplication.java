package com.things.application;
...
import com.things.R;
import com.things.log.Log4jConfigure;
import com.things.manager.IDemoCallback;
import com.things.manager.InitManager;
...
public class mApplication extends Application {
    ...
    private void showToast(final String message) {
        ThreadTools.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(mApplication.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }


    public void creachInfo(){

        new Thread.UncaughtExceptionHandler() {
            @Override
            public void uncaughtException(Thread thread, Throwable throwable) {

                Log4jConfigure.debug(throwable.getMessage());
